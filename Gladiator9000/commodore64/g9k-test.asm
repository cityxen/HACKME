...
up9600_read:
    ...
    rts
!over:
    ldx up9600_string_buffer_cursor // store the string in read string buffer (256 bytes)
    inc up9600_string_buffer_cursor
    sta up9600_string_buffer,x
    cmp #$0a
    beq up9600_parse
    rts
...
!lp:
    ...
    cpx up9600_string_buffer_cursor
    bne !lp-
...
up9600_zero_read_string:
    lda #$00
    sta up9600_string_buffer_cursor
    ldx #$00
!lp:
    sta up9600_string_buffer,x
    inx
...
up9600_string_buffer_cursor:
.byte 0
up9600_string_buffer:
.fill 256,0
